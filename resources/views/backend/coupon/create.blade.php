...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Thêm Mã Giảm Giá <a href="{{route('admin.coupon.index')}}" class="btn bg-purple "><i class="fa fa-plus"></i> Danh sách Mã Giảm Giá</a>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Nhập thông tin Mã Giảm Giá</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                            ...
                            <div class="box-body">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input data-validation="required"  data-validation-error-msg ="Điền tên mã giảm giá có ít nhất 1 ký tự"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="brand_slug" name="coupon_time" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="brand_slug" name="coupon_number" >

                                    </div>

                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Mã giảm giá</label>
                                        <input class="form-control" type="text" id="brand_slug" name="coupon_code" >

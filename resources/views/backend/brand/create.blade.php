...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Thêm NCC <a href="{{route('admin.brand.index')}}" class="btn bg-purple "><i class="fa fa-plus"></i> Danh sách NCC</a>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Nhập thông tin NCC</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">brand_slug</label>
                    <input class="form-control" type="text" id="brand_slug" name="brand_slug" >


                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">brand_desc </label>
                  <textarea   rows="3" class="form-control" name ="brand_desc"
                  id="brand_desc" placeholder="Enter brand_desc"></textarea>

                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">brand_status</label>
                  <input type="number" class="form-control" name ="brand_status" id="brand_status" placeholder="Enter brand_status">
                  @if($errors->has('brand_status'))
                  <label class="Text-red" style="font-size:15px;font-weight:600;margin-top:5px;color:red" >
                              <i class="fa fa-info"></i>{{$errors->first('brand_status')}}
                    </label>
                  @endif
                </div>
